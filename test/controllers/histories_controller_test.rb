...
class HistoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create history" do
    assert_difference('History.count') do
      post histories_url, params: { history: { amount: @history.amount, brand: @history.brand, order_code: @history.order_code, product: @history.product } }
    end
  ...
  test "should update history" do
    patch history_url(@history), params: { history: { amount: @history.amount, brand: @history.brand, order_code: @history.order_code, product: @history.product } }
